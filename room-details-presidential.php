...
<body> 
    ...
    <main>
        ...
        <div class="hero small-height jarallax" data-jarallax data-speed="0.2">
            <img class="jarallax-img kenburns" src="img/rooms/1350-by-350presidential.jpg" alt="">
            ...
            <div class="container-fluid p-lg-0">
                <div data-cues="zoomIn">
                    <div class="owl-carousel owl-theme carousel_item_centered kenburns rounded-img">
                        <div class="item">
                            <img src="img/rooms/president-suite1.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/president-suite2.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/president-suite3.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/president-suite4.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="text-center mt-5">
                    <a class="btn_1 outline" data-fslightbox="gallery_1" data-type="image" href="img/rooms/president-suite3.jpg">FullScreen Gallery</a>
                    <a data-fslightbox="gallery_1" data-type="image" href="img/rooms/president-suite2.jpg"></a>
                    <a data-fslightbox="gallery_1" data-type="image" href="img/rooms/president-suite4.jpg"></a>
                    <a data-fslightbox="gallery_1" data-type="image" href="img/rooms/president-suite1.jpg"></a>
                </div>
            </div>
        </div>
        <!-- /bg_white -->
            ...
            <div class="container add_bottom_120">
                <div class="row justify-content-between">
                    <div class="col-lg-6">
                        ...
                        <p style="text-align: justify;">Discover the epitome of luxury in Countryard Resort's Presidential Suite. This exclusive haven features refined wooden flooring, seamlessly marrying sophistication with comfort. Unwind as panoramic vistas unfold outside your window, creating a tranquil connection to nature. Meticulously designed, the suite harmonizes opulent furnishings with thoughtful amenities for an unparalleled experience. </p>
                        <p style="text-align: justify;">With en-suite facilities that epitomize luxury, the Presidential Suite is a private sanctuary designed to exceed your desires. Immerse yourself in a world of elegance where every element, from flooring to vistas, creates an unforgettable retreat of indulgence and serenity.</p>
                    </div>
                    ...
                    <div class="review_card">
                        <div class="row">
                            ...
                            <div class="col-md-10 review_content">
                                ...
                                <p>My stay at the Presidential Suite of Countryard exceeded all expectations. The opulence and attention to detail were truly remarkable. From the spacious living area to the private bar, every corner exuded luxury. The personalized service was exceptional, and the panoramic city view from my suite was breathtaking. An experience of pure indulgence.</p>
                            </div>
                        </div>
                        <!-- /row -->
                    </div>
                    ...
                    <div class="review_card">
                        <div class="row">
                            ...
                            <div class="col-md-10 review_content">
                                ...
                                <p>My stay in the Presidential Suite at Countryard was an unforgettable journey into elegance. The lavish bedroom with its exquisite bathroom felt like a haven of comfort. The butler service added a touch of grandeur, and the assortment of amenities, from champagne to fresh flowers, made me feel truly pampered.</p>
                            </div>
                        </div>
                        <!-- /row -->
                    </div>
                    ...
                    <div class="review_card">
                        <div class="row">
                            ...
                            <div class="col-md-10 review_content">
                                ...
                                <p>The Presidential Suite at Countryard is a haven of sophistication. The expansive space, elegant furnishings, and high-end facilities made my stay not just comfortable, but truly indulgent. A top-notch experience, especially for business travelers seeking luxury and convenience.</p>
                            </div>
                        </div>
                        <!-- /row -->
                        <!-- <div class="row reply">
                    ...
                    <div class="row" data-cues="slideInUp" data-delay="800">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                            <a href="room-details-leopard.php" class="box_cat_rooms">
                                <figure>
                                    <div class="background-image" data-background="url(img/rooms/leopard-lair.jpg)"></div>
                                    <div class="info">
