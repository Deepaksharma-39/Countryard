...
<head>
    ...
    <title>Countryard - About Us</title>
    ...
    <main>
        <div class="hero small-height jarallax" data-jarallax data-speed="0.2">
            ...
            <div class="wrapper opacity-mask d-flex align-items-center justify-content-center text-center animate_hero"
                ...
                <div class="container">
                    <small class="slide-animated one">Experiencing Luxury</small>
                    <h1 class="slide-animated two">Amidst the Serenity of Nature</h1>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="intro">
                        ...
                        <p class="lead">Welcome to the sanctuary known as Countryard, where a spectrum of nature-centric
                            activities awaits your eager exploration. A haven crafted to rejuvenate weary souls, to
                            immerse in the tranquility that only nature can provide.</p>
                        <p>Tracing its lineage back to 1936, Jim Corbett National Park proudly stands as India's
                            inaugural national park. Once named the Hailey National Park in tribute to William Malcolm
                            Hailey during the British colonial era, its identity transformed after India gained
                            independence. Now bearing the name Corbett National Park, it stands as a tribute to the
                            legendary Jim Corbett, a distinguished naturalist and skilled hunter who played a pivotal
                            role in its establishment. </p>
                        <p>Within the confines of this extraordinary destination, history, nature, and reverence come
                            together to create an unforgettable experience. Explore, discover, and embrace the legacy of
                            both Countryard and Jim Corbett National Park – a testament to our enduring connection with
                            the natural world.</p>
                        <p><em>Countryard...by EWD</em></p>
                    </div>
                </div>
            </div>
            <!-- /Row -->
            ...
            <div class="container margin_120_95">
                <div class="row justify-content-between d-flex align-items-center add_bottom_90">
                    ...
                    <div class="col-lg-5">
                        <div class="title">
                            ...
                            <h3>Wildlife-rich: Corbett National Park</h3>
                            <p>Indulge in the pinnacle of opulence with our Presidential Suite. Impeccable design,
                                lavish amenities, and personalized service converge in this haven of refined luxury.
                                Experience unrivaled comfort and sophistication.</p>
                ...
                <div class="row justify-content-between d-flex align-items-center add_bottom_90">
                    ...
                    <div class="col-lg-5 order-lg-1">
                        <div class="title">
                            <!-- <small>High-tech Conference Hall</small> -->
                            <h3>Embracing Nature's Tapestry</h3>

                            <p>Discover the epitome of sophisticated gatherings in our state-of-the-art Conference Hall.
                                A distinguished space where innovation and elegance unite for seamless corporate events
                                and impactful meetings.</p>
                            <!-- <p><a href="about.html" class="btn_1 mt-1 outline">Read more</a></p> -->
                        </div>
                    </div>
                </div>
                            ...
                            <div class="carousel_testimonials owl-carousel owl-theme nav-dots-orizontal">
                                <div>
                                    <div class="box_overlay">
                                        ...
                                        <div class="comment">
                                            "The Countryard's work has breathed new life into our community. Their
                                            commitment to sustainable and low-maintenance designs has made our
                                            neighborhood a more vibrant and welcoming place to live. "
                                        </div>
                                    </div>
                                    <!-- End box_overlay -->
                                </div>
                                <div>
                                    <div class="box_overlay">
                                        ...
                                        <div class="comment">
                                            "Planning outdoor events can be stressful, but The Countryard turned it into
                                            a joyous experience. Their team's creativity and flawless execution
                                            transformed our event space into a magical setting."
                                        </div>
                                    </div>
                                    <!-- End box_overlay -->
                                </div>
                                <div>
                                    <div class="box_overlay">
                                        ...
                                        <div class="comment">
                                            "I entrusted The Countryard with revamping my backyard, They transformed the
                                            space into a breathtaking oasis that I now enjoy every day. Their team's
                                            attention to detail and dedication to my vision were remarkable. "
                                        </div>
                                    </div>
                                    <!-- End box_overlay -->
                                </div>
        ...
        <div class="container margin_120_95">
            ...
            <div class="row justify-content-between margin_60_0">
                <div class="col-lg-4">
                    ...
                    <p><a href="contact.php" class="animated_link"><strong>Contact Us <i
                    ...
                    <div role="tablist" class="mb-5 accordion" id="faq">
                            ...
                            <div id="collapseOne_product" class="collapse" role="tabpanel" data-bs-parent="#faq">
                                <div class="card-body">
                                    <p>Our cancellation policy outlines the guidelines and conditions related to
                                        canceling your resort booking. It's important to review this policy before
                                        making any changes to your reservation.</p>
                                </div>
                            </div>
                        </div>
                        <!-- /card -->
                            ...
                            <div id="collapseTwo_product" class="collapse" role="tabpanel" data-bs-parent="#faq">
                                <div class="card-body">
                                    <p>We accept various payment methods, including major credit cards, debit cards, and
                                        electronic bank transfers. Please check our website or contact our reservations
                                        team for specific options.</p>
                            ...
                            <div id="collapseThree_product" class="collapse" role="tabpanel" data-bs-parent="#faq">
                                <div class="card-body">
                                    <p>Early check-in is subject to availability and may incur an additional fee. Please
                                        contact our reservations team in advance to inquire about early check-in
                                        options.</p>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFour_product" class="collapse" role="tabpanel" data-bs-parent="#faq">
                                <div class="card-body">
                                    <p>Yes, we are committed to providing accessible facilities. Our resort provides wheelchair and other amenities to ensure ease of movement for guests
                                        with disabilities.</p>
