...
<body>
    ...
    <main>
        ...
        <div class="hero small-height jarallax" data-jarallax data-speed="0.2">
            <img class="jarallax-img kenburns" src="img/rooms/1350-by-350deer.webp" alt="">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <p class="slide-animated three">Refined serenity within our elegantly designed Deer Park
                                resort rooms</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid p-lg-0">
                <div data-cues="zoomIn">
                    <div class="owl-carousel owl-theme carousel_item_centered kenburns rounded-img">
                        ...
                        <div class="item" style="position: relative; height: 420px; overflow: hidden;">
                            <img src="img/rooms/deer-park2.webp" alt="">
                        </div>
                        <div class="item" style="position: relative; height: 420px; overflow: hidden;">
                            <img src="img/rooms/deer-park1.webp" alt="">
                        </div>
                        <div class="item" style="position: relative; height: 420px; overflow: hidden;">
                            <img src="img/rooms/deer-park3.webp" alt="">
                        </div>
                        <div class="item" style="position: relative; height: 420px; overflow: hidden;">
                            <img src="img/rooms/deer-park4.webp" alt="">
                        </div>
                    </div>
                </div>
                <div class="text-center mt-5">
                    <a class="btn_1 outline" data-fslightbox="gallery_1" data-type="video"
                        ...
                        Gallery</a>
                    <a data-fslightbox="gallery_1" data-type="image" href="img/rooms/deer-park1.webp"></a>
                    <a data-fslightbox="gallery_1" data-type="image" href="img/rooms/deer-park3.webp"></a>
                    <a data-fslightbox="gallery_1" data-type="image" href="img/rooms/deer-park2.webp"></a>
                    <a data-fslightbox="gallery_1" data-type="image" href="img/rooms/deer-park4.webp"></a>
                </div>
            </div>
        </div>
        <!-- /bg_white -->
            ...
            <div class="container add_bottom_120">
                <div class="row justify-content-between">
                    <div class="col-lg-6">
                        ...
                        <p style="text-align: justify;">Embosomed an elevated level of comfort and impeccable service
                            within our Deer Park resort rooms. Our dedicated team is committed to ensuring your stay is
                            exceptional through seamless room service and tailored amenities. </p>
                        <p style="text-align: justify;">Prepare to immerse yourself in a realm of luxury, where
                            meticulous attention to detail is paramount, and your expectations are consistently
                            surpassed.</p>
                    </div>
                    ...
                    <div style="justify-content: center; margin-top: 40px; text-align: center;">
                        <h6><?php echo 'From &#8377 '.$deerParkPrice.'/night'; ?></h6>
                    </div>
