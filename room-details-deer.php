...
<head>
    ...
    <title>Countryard - Deer Park</title>
...
<body> 
    ...
    <main>
        ...
        <div class="hero small-height jarallax" data-jarallax data-speed="0.2">
            <img class="jarallax-img kenburns" src="img/rooms/1350-by-350deer.jpg" alt="">
            <div class="wrapper opacity-mask d-flex align-items-center  text-center animate_hero" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <small class="slide-animated one">Wildlife Retreat</small>
                            <h1 class="slide-animated two">Deer Park</h1>
                            <p class="slide-animated three">Refined serenity within our elegantly designed Deer Park resort rooms</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid p-lg-0">
                <div data-cues="zoomIn">
                    <div class="owl-carousel owl-theme carousel_item_centered kenburns rounded-img">
                        <div class="item">
                            <img src="img/rooms/deer-park1.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/deer-park2.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/deer-park3.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/deer-park4.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="text-center mt-5">
                    <a class="btn_1 outline" data-fslightbox="gallery_1" data-type="image" href="img/rooms/deer-park1.jpg">FullScreen Gallery</a>
                    <a data-fslightbox="gallery_1" data-type="image" href="img/rooms/deer-park3.jpg"></a>
                    <a data-fslightbox="gallery_1" data-type="image" href="img/rooms/deer-park2.jpg"></a>
                    <a data-fslightbox="gallery_1" data-type="image" href="img/rooms/deer-park4.jpg"></a>
                </div>
            </div>
        </div>
        <!-- /bg_white -->
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-6">
                        <div class="title">
                            ...
                            <h2>Deer Park Retreat: Where Tranquility Meets Timeless Elegance</h2>
                        </div>
                        <p style="text-align: justify;">Embosomed an elevated level of comfort and impeccable service within our Deer Park resort rooms. Our dedicated team is committed to ensuring your stay is exceptional through seamless room service and tailored amenities. </p>
                        <p style="text-align: justify;">Prepare to immerse yourself in a realm of luxury, where meticulous attention to detail is paramount, and your expectations are consistently surpassed.</p>
                    </div>
                    ...
                    <div class="review_card">
                        <div class="row">
                            ...
                            <div class="col-md-10 review_content">
                                ...
                                <p>My family and I had the pleasure of staying at the Deer Park Resort room. The unmatched balance between the opulent lodgings and the unspoiled natural splendor was beyond comparison. We were truly impressed by the thoughtful amenities and the attentive service</p>
                            </div>
                        </div>
                        <!-- /row -->
                    </div>
                    ...
                    <div class="review_card">
                        <div class="row">
                            ...
                            <div class="col-md-10 review_content">
                                ...
                                <p>The Deer Park Resort room was an oasis of calm and luxury. The fact that it's surrounded by a wildlife sanctuary added an extra layer of charm to my stay. The level of service and the attention to every detail made it a memorable visit.</p>
                            </div>
                    ...
                    <div class="review_card">
                        <div class="row">
                            ...
                            <div class="col-md-10 review_content">
                                ...
                                <p>Impeccable service and attention to detail define my stay at the Deer Park Resort room. The seamless room service and the fact that it's nestled within a wildlife sanctuary added a unique touch. A perfect escape from the city hustle!</p>
                            </div>
                        </div>
                    </div>
                </div>
